...
#
FROM rust:alpine3.21@sha256:77d036177a4caf204bf23c6c68e1aa013a0d919fd40058eb27943295080fe869 AS builder
...
COPY --from=builder /src/target/release/bellatrix /bin/bellatrix

WORKDIR /tmp

ENTRYPOINT ["/bin/bellatrix"]
