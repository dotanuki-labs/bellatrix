...
[good first issues](https://github.com/dotanuki-labs/bellatrix/labels/good%20first%20issue)
...
[GitHub issues](https://github.com/dotanuki-labs/bellatrix/issues?q=is%3Aopen+is%3Aissue+label%3Abug)
...
- Ensure you've read our [development guidelines](https://github.com/dotanuki-labs/bellatrix/blob/main/docs/development.md)
- Fork this project
...
- Code your changes 🔥
- Use our `xtasks` helpers to run [what we execute on CI](https://github.com/dotanuki-labs/bellatrix/blob/main/.github/workflows/ci.yml)
