...
- Add **notable changes** the to [changelog file](https://github.com/dotanuki-labs/bellatrix/blob/main/docs/changelog.md)
- Bump version at [Cargo.toml](https://github.com/dotanuki-labs/bellatrix/blob/main/Cargo.toml#L3)
...
- Execute the [CD Workflow](https://github.com/dotanuki-labs/bellatrix/actions/workflows/cd.yml)
- Go to the [releases page](https://github.com/dotanuki-labs/bellatrix/releases)
...
- Create a branch like `ufs/bellatrix-x.y.z`
- Update the `bellatrix.rb` formula with proper version and checksums
- Raise a PR
